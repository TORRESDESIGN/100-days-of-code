...
```
Basically I need to code an algorithm that loops through the multi-dimensional array & extracting the  largest number in each sub-array, and spit it out in it's own array, essentially this: [5,27,39,1001]
